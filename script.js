...
function signup(e){
    ...
    var img_url = localStorage.getItem('image');
...
function login(e)
{
    ...
    if(user == null){
        ...
        alert('Sai mật khẩu hoặc username');
    }
}
function update(e){
    localStorage.clear();
    ...
    if(password==null) password = document.getElementById("currentpass1").value;
    var bio = document.getElementById("bio1").value;
    const imageInput = document.getElementById('newavatar');
